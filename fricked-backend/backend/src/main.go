...
import (
	...
	"fricked-backend/src/globals"
	"fricked-backend/src/handlers"
	"fricked-backend/src/helpers/databases"
	"fricked-backend/src/types"
	"fricked-backend/src/utils"
	"log"
	"net"
	"os"
...
func main() {
	...
	app := fiber.New(fiber.Config{
		Prefork:      false,
		ServerHeader: "fricked-backend",
		AppName:      "fricked-backend v3.0",
